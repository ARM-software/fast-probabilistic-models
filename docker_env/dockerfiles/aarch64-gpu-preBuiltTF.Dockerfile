...
COPY required_files/tensorflow-2.4.1-cp38-cp38-linux_aarch64.whl /tmp/tensorflow-2.4.1-cp38-cp38-linux_aarch64.whl
RUN python3 -m pip install --no-cache-dir /tmp/tensorflow-2.4.1-cp38-cp38-linux_aarch64.whl
